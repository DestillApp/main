...
const corsOptions = {
  origin: "http://frontend:8080", // Allow requests from this origin
...
mongoose
  .connect(process.env.MONGODB_URI || "mongodb://127.0.0.1:27017/destillit") // MongoDB connection string
  .then((result) => {
    ...
    server
      ...
      .then(() => {
        ...
        app.listen(PORT, () => {
          console.log(
            `Server ready at http://backend:${PORT}${server.graphqlPath}`
